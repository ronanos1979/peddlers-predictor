...
const RULES = {
  en: {
    ...
    prizeBody: 'Drawn by raffle at the end of the World Cup Final on July 19, 2026. All entries from Haverhill and Nashua compete together in one combined draw. Correct result = 1 ticket, exact score = 3 tickets, hat-trick bonus = +7 tickets. The more you predict, the better your odds.',
    sections: [
      ['📱 How to enter', [
      ...
      ['🎯 Scoring & raffle entries', [
        ...
        'Hat-trick bonus: predict that any player will score 3+ goals in the match — earn +7 raffle entries if correct',
      ...
      ['🎲 The TV raffle draw', [
        ...
        'Your raffle entries = 1 per correct result + 2 bonus per exact score + 7 bonus if hat-trick prediction is correct',
  ...
  es: {
    ...
    prizeBody: 'Se sortea al final de la Final del Mundial el 19 de julio de 2026. Todas las entradas de Haverhill y Nashua compiten juntas en un único sorteo. Resultado correcto = 1 boleto, marcador exacto = 3 boletos, bono hat-trick = +7 boletos. Cuanto más predices, mayores son tus posibilidades.',
    sections: [
      ['📱 Cómo participar', [
      ...
      ['🎯 Puntuación y boletos de rifa', [
        ...
        'Bono hat-trick: predice que algún jugador marcará 3 o más goles en el partido — gana +7 boletos si aciertas',
      ...
      ['🎲 Sorteo del televisor', [
        ...
        'Tus boletos = 1 por resultado correcto + 2 de bonificación por marcador exacto + 7 de bonificación si aciertas el hat-trick',
