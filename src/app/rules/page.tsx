...
const RULES = {
  en: {
    ...
    prizeBody: 'Drawn by raffle at the end of the World Cup Final on July 19, 2026. All entries from Haverhill and Nashua compete together in one combined draw. Correct result = 1 ticket, exact score = 3 tickets, hat-trick bonus (name the scorer) = +7 tickets. The more you predict, the better your odds.',
    sections: [
      ['📱 How to enter', [
      ...
      ['🎯 Scoring & raffle entries', [
        ...
        'Hat-trick bonus: name a specific player you think will score 3+ goals — earn +7 raffle entries if that player scores a hat-trick',
        'Hat-trick bonus is independent of the result — you can earn it even if your result pick was wrong',
        'Partial names work — "Messi" counts if Lionel Messi scores the hat-trick',
      ...
      ['🎲 The TV raffle draw', [
        ...
        'Your raffle entries = 1 per correct result + 2 bonus per exact score + 7 bonus if your named hat-trick scorer scores 3+ goals',
  ...
  es: {
    ...
    prizeBody: 'Se sortea al final de la Final del Mundial el 19 de julio de 2026. Todas las entradas de Haverhill y Nashua compiten juntas en un único sorteo. Resultado correcto = 1 boleto, marcador exacto = 3 boletos, bono hat-trick (nombra al anotador) = +7 boletos. Cuanto más predices, mayores son tus posibilidades.',
    sections: [
      ['📱 Cómo participar', [
      ...
      ['🎯 Puntuación y boletos de rifa', [
        ...
        'Bono hat-trick: nombra un jugador específico que crees que marcará 3 o más goles — gana +7 boletos si ese jugador logra el hat-trick',
        'El bono hat-trick es independiente del resultado — puedes ganarlo aunque tu predicción de resultado sea incorrecta',
        'Los nombres parciales funcionan — "Messi" cuenta si Lionel Messi marca el hat-trick',
      ...
      ['🎲 Sorteo del televisor', [
        ...
        'Tus boletos = 1 por resultado correcto + 2 de bonificación por marcador exacto + 7 de bonificación si el jugador que nombraste marca el hat-trick',
