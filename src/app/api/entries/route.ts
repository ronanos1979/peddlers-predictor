...
export async function POST(req: NextRequest) {
  try {
    ...
    // Check daily code — auto-generated from today's date
    // Also accept yesterday's code for late-night matches crossing midnight
    ...
    // Check match exists and entries are still open
