...
-- Last updated: 2026-05-30 (fixed team names to match local schedule names)
--
-- Team name notes — the matches table uses LOCAL schedule names, not API names:
...
-- Keyed by home_team + away_team + kickoff date (UTC). Run the whole block
-- at once; rows that don't match (e.g. wrong team name in DB) are silently skipped.
...
update matches set venue = 'AT&T Stadium, Arlington, TX'            where home_team='Canada'        and away_team ilike 'Bosnia%'      and kickoff_at::date='2026-06-12';
...
update matches set venue = 'BC Place, Vancouver, BC'                where home_team='Switzerland'   and away_team ilike 'Bosnia%'      and kickoff_at::date='2026-06-18';
...
update matches set venue = 'BC Place, Vancouver, BC'                where home_team ilike 'Bosnia%' and away_team='Qatar'              and kickoff_at::date='2026-06-24';
...
-- "USA" in DB, "Türkiye" in DB
update matches set venue = 'MetLife Stadium, East Rutherford, NJ'   where home_team='USA'           and away_team='Paraguay'           and kickoff_at::date='2026-06-13';
update matches set venue = 'Estadio Akron, Guadalajara'             where home_team='Australia'     and away_team='Türkiye'            and kickoff_at::date='2026-06-14';
update matches set venue = 'MetLife Stadium, East Rutherford, NJ'   where home_team='USA'           and away_team='Australia'          and kickoff_at::date='2026-06-19';
update matches set venue = 'Estadio Akron, Guadalajara'             where home_team='Türkiye'       and away_team='Paraguay'           and kickoff_at::date='2026-06-20';
update matches set venue = 'MetLife Stadium, East Rutherford, NJ'   where home_team='Türkiye'       and away_team='USA'                and kickoff_at::date='2026-06-26';
...
-- "Ivory Coast" in DB; "Curaçao" — try both spellings just in case
update matches set venue = 'Levi''s Stadium, Santa Clara, CA'       where home_team='Germany'       and away_team ilike 'Cura%'        and kickoff_at::date='2026-06-14';
...
update matches set venue = 'Levi''s Stadium, Santa Clara, CA'       where home_team='Ecuador'       and away_team ilike 'Cura%'        and kickoff_at::date='2026-06-21';
...
update matches set venue = 'Arrowhead Stadium, Kansas City, MO'     where home_team ilike 'Cura%'   and away_team='Ivory Coast'        and kickoff_at::date='2026-06-25';
...
update matches set venue = 'NRG Stadium, Houston, TX'               where home_team='Iran'          and away_team ilike 'New Zealand%' and kickoff_at::date='2026-06-16';
...
update matches set venue = 'NRG Stadium, Houston, TX'               where home_team ilike 'New Zealand%' and away_team='Egypt'         and kickoff_at::date='2026-06-22';
update matches set venue = 'Gillette Stadium, Foxborough, MA'       where home_team ilike 'New Zealand%' and away_team='Belgium'       and kickoff_at::date='2026-06-27';
...
-- "Cape Verde" — try ilike to match both "Cape Verde" and "Cape Verde Islands"
update matches set venue = 'Lincoln Financial Field, Philadelphia, PA' where home_team='Spain'      and away_team ilike 'Cape Verde%'  and kickoff_at::date='2026-06-15';
...
update matches set venue = 'Lumen Field, Seattle, WA'               where home_team='Uruguay'       and away_team ilike 'Cape Verde%'  and kickoff_at::date='2026-06-21';
...
update matches set venue = 'Lincoln Financial Field, Philadelphia, PA' where home_team ilike 'Cape Verde%' and away_team='Saudi Arabia' and kickoff_at::date='2026-06-27';
...
-- "Congo DR" — use ilike to match variations
update matches set venue = 'NRG Stadium, Houston, TX'               where home_team='Portugal'      and away_team ilike '%Congo%'      and kickoff_at::date='2026-06-17';
...
update matches set venue = 'Empower Field at Mile High, Denver, CO' where home_team='Colombia'      and away_team ilike '%Congo%'      and kickoff_at::date='2026-06-24';
...
update matches set venue = 'NRG Stadium, Houston, TX'               where home_team ilike '%Congo%' and away_team='Uzbekistan'         and kickoff_at::date='2026-06-27';
